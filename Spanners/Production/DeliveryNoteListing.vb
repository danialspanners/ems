Public Class DeliveryNoteListForm
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DNGrid As DevExpress.XtraGrid.GridControl
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DNGrid = New DevExpress.XtraGrid.GridControl
        ...
        CType(Me.DNGrid, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'DNGrid
        '
        Me.DNGrid.EditorsRepository = Me.PersistentRepository1
        Me.DNGrid.Location = New System.Drawing.Point(8, 8)
        Me.DNGrid.MainView = Me.GridView1
        Me.DNGrid.Name = "DNGrid"
        Me.DNGrid.Size = New System.Drawing.Size(712, 296)
        Me.DNGrid.TabIndex = 2
        '
        ...
        Me.RevisedBtn.Location = New System.Drawing.Point(160, 320)
        ...
        Me.Controls.Add(Me.DNGrid)
        Me.Location = New System.Drawing.Point(8, 8)
        Me.Name = "DeliveryNoteListForm"
        Me.Text = "Delivery Note Listing"
        CType(Me.DNGrid, System.ComponentModel.ISupportInitialize).EndInit()
...
#Region " Form Load "
    Private Sub DeliveryNoteListForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadDeliveryNoteList()
        Timer1.Interval = 60000
        Timer1.Start()
        DNGrid_Click(sender, e)
    End Sub

    Public Sub LoadDeliveryNoteList()
        Dim ds As DataSet
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    For Each oRow In ds.Tables(0).Rows
                        ...
                        With New BusinessRules.WorkOrderBusRules.WorkLogicBusLogic
                            If Not IsDBNull(oRow("WO_ID")) Then
                                If .GetWOHeader(dsWO, oRow("WO_ID")) Then
                                    If Not dsWO Is Nothing Then
                        ...
                        With New BusinessRules.SupplierBusRules.SupplierBusLogic
                            If Not IsDBNull(oRow("Supplier_ID")) Then
                                If .GetSupplier(dsSupplier, oRow("Supplier_ID")) Then
                                    If Not dsSupplier Is Nothing Then
                                        Supplier = dsSupplier.Tables(0).Rows(0)("Supplier_Name")
                                    End If
                                End If
                            End If
                        End With

                        data.Rows.Add(New Object() {oRow("DN_ID"), i, oRow("DN_No"), Status, oRow("Status"), WO_No, Supplier, ChangeDateFormat(oRow("Completion_Date"))})
                    Next
                    DNGrid.DataSource = data
                    DNGrid.DefaultView.PopulateColumns()
    ...
    Private Sub InitGrid()
        ...
        data.BeginInit()
        AddColumn(data, "DN ID", System.Type.GetType("System.Int16"), True)
        AddColumn(data, " ", System.Type.GetType("System.Int16"), True)
        AddColumn(data, "Delivery Note No", System.Type.GetType("System.String"), True)
        AddColumn(data, "Status", System.Type.GetType("System.String"), True)
        AddColumn(data, "StatusID", System.Type.GetType("System.Int16"), True)
        AddColumn(data, "Work Order", System.Type.GetType("System.String"), True)
...
#End Region
    ...
    Private Sub DNGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DNGrid.Click
...
#Region " Button Event"
    ...
    Private Sub RevisedBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RevisedBtn.Click
        If Not GridView1.IsGroupRow(GridView1.GetSelectedRows(0)) Then
            ...
            Dim dr As DataRow
            dr = GridView1.GetDataRow(Row)
            Dim DN_ID As Integer = dr(0)
            Dim Result As DialogResult = MessageBox.Show("Are you sure you want to create a revised Delivery Note?", "Order Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            ...
            If Result = DialogResult.Yes Then
                ...
                '                controlToAdd = New DeliveryNoteForm("REVISED", , , DN_ID)
                page = New Crownwood.Magic.Controls.TabPage("Revised Delivery Note", controlToAdd, ImageList1, 0)
    ...
    Private Sub NewBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NewBtn.Click
        ...
        Dim page As Crownwood.Magic.Controls.TabPage
        controlToAdd = New DeliveryNoteForm("NEW")
        page = New Crownwood.Magic.Controls.TabPage("New Delivery Note", controlToAdd, ImageList1, 0)
    ...
    Private Sub DelBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DelBtn.Click
        If Not GridView1.IsGroupRow(GridView1.GetSelectedRows(0)) Then
            ...
            dr = GridView1.GetDataRow(Row)
            Dim DN_ID As Integer = dr(0)
            Dim Result As DialogResult = MessageBox.Show("Are you sure you want to delete this Delivery Note?", "Order Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            If Result = DialogResult.Yes Then
                With New BusinessRules.DeliveryNoteBusRules.DeliveryNoteBusLogic
                    .UserID = UserID
                    If .DeleteDeliveryNote(DN_ID) Then
                        MessageBox.Show("Delivery Note Deleted.", "Delivery Note", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    End If
                End With
            End If
            Me.LoadDeliveryNoteList()
        End If
    End Sub
    ...
    Private Sub EditBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditBtn.Click
        If Not GridView1.IsGroupRow(GridView1.GetSelectedRows(0)) Then
            ...
            If Status = "50" Then       'Confirmed. View only
                controlToAdd = New DeliveryNoteForm("VIEW", DN_ID)
                page = New Crownwood.Magic.Controls.TabPage("View Delivery Note", controlToAdd, ImageList1, 0)
            Else
                controlToAdd = New DeliveryNoteForm("EDIT", DN_ID)
                page = New Crownwood.Magic.Controls.TabPage("Edit Delivery Note", controlToAdd, ImageList1, 0)
            End If
    ...
    Private Sub PrintBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintBtn.Click
        If Not GridView1.IsGroupRow(GridView1.GetSelectedRows(0)) Then
            ...
            Dim page As Crownwood.Magic.Controls.TabPage
            controlToAdd = New DeliveryNoteReportForm(DN_ID)
            page = New Crownwood.Magic.Controls.TabPage("Print Delivery Note", controlToAdd, ImageList1, 0)
...
#End Region
    ...
    Private Sub DeliveryNoteListForm_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
        If e.KeyValue = 116 Then    'F5 key
            LoadDeliveryNoteList()
        End If
    End Sub

    Private Sub DNGrid_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles DNGrid.KeyUp
        If e.KeyValue = 116 Then    'F5 key
            LoadDeliveryNoteList()
        End If
    End Sub
    ...
    Private Sub DeliveryNoteListForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Dim a As MainForm = Me.ParentForm
