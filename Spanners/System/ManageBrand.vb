...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents BrandList As System.Windows.Forms.ListBox
    Friend WithEvents Brandtxt As DevExpress.XtraEditors.TextEdit
    Friend WithEvents ImageList1 As System.Windows.Forms.ImageList
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ManageBrandForm))
        ...
        Me.Brandtxt = New DevExpress.XtraEditors.TextEdit
        Me.Label1 = New System.Windows.Forms.Label
        Me.BrandList = New System.Windows.Forms.ListBox
        Me.ImageList1 = New System.Windows.Forms.ImageList(Me.components)
        Me.GroupBox1.SuspendLayout()
        CType(Me.Brandtxt, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'GroupBox1
        '
        ...
        Me.GroupBox1.Controls.Add(Me.Brandtxt)
        Me.GroupBox1.Controls.Add(Me.Label1)
        Me.GroupBox1.Controls.Add(Me.BrandList)
        Me.GroupBox1.Location = New System.Drawing.Point(8, 6)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(304, 346)
        Me.GroupBox1.TabIndex = 3
        Me.GroupBox1.TabStop = False
        Me.GroupBox1.Text = "Brand"
        '
        'CancelBtn
        '
        ...
        Me.NewBtn.Location = New System.Drawing.Point(184, 240)
        Me.NewBtn.Name = "NewBtn"
        Me.NewBtn.Size = New System.Drawing.Size(104, 24)
        Me.NewBtn.TabIndex = 121
        Me.NewBtn.Text = "New Brand"
        '
        'DeleteBtn
        '
        ...
        'Brandtxt
        '
        Me.Brandtxt.Location = New System.Drawing.Point(80, 272)
        Me.Brandtxt.Name = "Brandtxt"
        Me.Brandtxt.Properties.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.UltraFlat
        Me.Brandtxt.Size = New System.Drawing.Size(208, 19)
        Me.Brandtxt.TabIndex = 114
        '
        'Label1
        '
        ...
        'BrandList
        '
        Me.BrandList.Location = New System.Drawing.Point(8, 24)
        Me.BrandList.Name = "BrandList"
        Me.BrandList.Size = New System.Drawing.Size(280, 199)
        Me.BrandList.TabIndex = 112
        '
        'ImageList1
        '
        ...
        Me.Name = "ManageBrandForm"
        Me.Text = "Brand"
        Me.GroupBox1.ResumeLayout(False)
        CType(Me.Brandtxt, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    ' 06.01.2004 YG Start
    Dim FunctionName As String = "MyBrand"
    ' 06.01.2004 YG End
    ...
    Private Sub ManageBrandForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ' 06.01.2004 YG Start
    ...
    Private Sub LoadBrand()
        Dim ds As DataSet
        With New BusinessRules.SystemBusRules.BrandBusLogic
            If .GetBrand(ds) Then
                If Not ds Is Nothing Then
                    Try
                        BrandList.DisplayMember = "Brand_Name"
                        BrandList.ValueMember = "Brand_ID"

                        BrandList.DataSource = ds.Tables(0)
    ...
    Private Sub SaveBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveBtn.Click
        If ValidData() Then
            If Not BrandNameExist() Then
                With New BusinessRules.SystemBusRules.BrandBusLogic
                    .Brand_Name = Brand_Name
                    .UserID = UserID
                    If Brand_ID = 0 Or Brand_ID = Nothing Then
                        If .SaveBrand() Then
                            MessageBox.Show("Brand saved. ", "Brand", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        End If
                    Else
                        .UpdateBrand(Brand_ID)
                        MessageBox.Show("Brand updated. ", "Brand", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    End If
                    Me.LoadBrand()
                    ResetForm()
                End With
            Else
                MessageBox.Show("Brand Name already exist !", "Manage Brand", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
        End If
    End Sub
    ...
    Private Function ValidData() As Boolean
        ...
        Brand_Name = Brandtxt.Text

        If Not Len(Brand_Name) > 0 Then
            DataOK_Flag = False
            FieldName = "Brand" & Chr(13)
        End If
    ...
    End Function
    '## Added by Alan
    Private Function BrandNameExist() As Boolean
        ...
        With New BusinessRules.SystemBusRules.BrandBusLogic
            If .GetBrand(dsBrand) Then
                rowCount = dsBrand.Tables(0).Rows.Count()
                For i = 0 To (rowCount - 1)
                    If UCase(Brand_Name) = UCase(dsBrand.Tables(0).Rows(i).Item("Brand_Name")) Then
                        NameExist_Flag = True
                        'BrandNameExist = NameExist_Flag
                        Exit For
                    Else
    ...
    Private Sub DeleteBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteBtn.Click
        Dim Result As DialogResult = MessageBox.Show("Confirm delete? ", "Delete Brand", MessageBoxButtons.YesNo, MessageBoxIcon.Question)

        If Result = DialogResult.Yes Then
            Brand_ID = BrandList.SelectedValue.ToString
            With New BusinessRules.SystemBusRules.BrandBusLogic
                .Brand_ID = Brand_ID
                If .DeleteBrand() Then
                    MessageBox.Show("Brand deleted. ", "Brand", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    LoadBrand()
                End If
            End With
        End If
    ...
    Private Sub BrandList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BrandList.SelectedIndexChanged
        ' 06.01.2004 YG Start
        Dim a As MainForm = Me.ParentForm
        ...
        With New BusinessRules.SystemBusRules.BrandBusLogic
            If .GetBrand(ds, Brand_ID) Then
                Brandtxt.Text = ds.Tables(0).Rows(0)("Brand_Name")
            End If
        End With
        SaveBtn.Text = "Update"
    End Sub

    Private Sub ManageBrandForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Dim a As MainForm = Me.ParentForm
