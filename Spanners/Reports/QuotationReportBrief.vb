...
Public Class QuotationReportBriefForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(QuotationReportBriefForm))
        ...
        Me.Panel3.Size = New System.Drawing.Size(669, 66)
        ...
        Me.Panel4.Location = New System.Drawing.Point(531, 0)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 194)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(669, 267)
...
#End Region
    ...
    Private Sub QuotationReportBriefForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If .GetQuotationRpt(ds, Quotation_ID, QuotationTitle) Then
                Try
                    ...
                    Select Case (Special_ID)
                        Case 1
                            'C1Report1.Load("../Reports/QuotationBrief.xml", "Quotation")
                            C1Report1.Load(path & "QuotationBrief.xml", "Quotation")
                        Case 2
                            'C1Report1.Load("../Reports/QuotationForBoxSurveyBrief.xml", "Quotation For Box Survey")
                            C1Report1.Load(path & "QuotationForBoxSurveyBrief.xml", "Quotation For Box Survey")
                        Case 3
                            'C1Report1.Load("../Reports/QuotationForCableSurveyBrief.xml", "Quotation For Cable Survey")
                            C1Report1.Load(path & "QuotationForCableSurveyBrief.xml", "Quotation For Cable Survey")
                        Case 4
                            'C1Report1.Load("../Reports/QuotationForSwitchboardBrief.xml", "Quotation For Switchboard")
                            C1Report1.Load(path & "QuotationForSwitchboardBrief.xml", "Quotation For Switchboard")
                    End Select
