...
Public Class LVBReportsPendingTOCRptForm
    Inherits System.Windows.Forms.Form

#Region " Windows Form Designer generated code "

    Public Sub New(ByVal pIO_ID As Integer, ByVal pSeparateByOfficers As Boolean, ByVal pSortby As Integer)
        MyBase.New()
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(LVBReportsPendingTOCRptForm))
        ...
        Me.Panel1.Size = New System.Drawing.Size(870, 55)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 443)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(870, 516)
        ...
        '
        'LVBReportsPendingTOCRptForm
        '
        Me.AutoScroll = True
        Me.ClientSize = New System.Drawing.Size(870, 571)
        Me.Controls.Add(Me.C1PrintPreviewControl1)
        Me.Controls.Add(Me.Panel1)
        Me.Name = "LVBReportsPendingTOCRptForm"
...
#End Region
    ...
    Private Sub LVBDeclarationWorkCompletionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With New BusinessRules.LVBBusRules.LVBBusLogic
            ...
            If .GetLVBPendingTOCReport(ds, Me.IO_ID, Me.Sortby) Then
                Try
                    tmpCurDir = Application.StartupPath()
                    Directory.SetCurrentDirectory(tmpCurDir & "\..\Reports\")

                    'C1Report2.Load("path & LVBReportsPendingTOC.xml", "Pending TOC")
                    C1Report2.Load("LVBReportsPendingTOC1.xml", "Pending TOC")
                    C1Report2.Fields(sSub).Subreport.DataSource.ConnectionString = ConnectionString
                    SQLStrT = .GetLVBPendingTOCReportSub(ds2, Me.IO_ID, Me.Sortby)
