...
Public Class OrderConfirmationReportForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OrderConfirmationReportForm))
        ...
        Me.CloseBtn.Location = New System.Drawing.Point(600, 504)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 626)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(672, 699)
        ...
        Me.Panel1.Location = New System.Drawing.Point(0, 699)
        ...
        Me.Name = "OrderConfirmationReportForm"
...
#End Region
    ...
    Private Sub OrderConfirmationReportForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                            ...
                            Select Case (Special_ID)
                                Case 1
                                    If Len(dsTmp.Tables(0).Rows(0)("Customer_PO")) > 0 Then
                                        ...
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            C1Report2.Load(path & "OrderConfirmationwoSign.xml", "Order Confirmation")
                                    ...
                                    Else
                                        ...
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            C1Report2.Load(path & "OrderConfirmation.xml", "Order Confirmation")
                                            C1Report2.DataSource.Recordset = ds.Tables(0)
                                            C1PrintPreviewControl1.Document = C1Report2.Document
                                        End If
                                    End If
                                ...
                                Case 2
                                    If Len(dsTmp.Tables(0).Rows(0)("Customer_PO")) > 0 Then
                                        '** IF THERE'S PO NO, CHOOSE THE REPORT W/O SIGNATURE **
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            C1Report2.Load(path & "OrderConfirmationForBoxSurveywoSign.xml", "Order Confirmation For Box Survey")
                                            C1Report2.DataSource.Recordset = ds.Tables(0)
                                            C1PrintPreviewControl1.Document = C1Report2.Document
                                        End If
                                    Else
                                        '** REPORT WITH SIGNATURE **
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            C1Report2.Load(path & "OrderConfirmationForBoxSurvey.xml", "Order Confirmation For Box Survey")
                                            C1Report2.DataSource.Recordset = ds.Tables(0)
                                            C1PrintPreviewControl1.Document = C1Report2.Document
                                        End If
                                    End If
                                ...
                                Case 3
                                    If Len(dsTmp.Tables(0).Rows(0)("Customer_PO")) > 0 Then
                                        '** IF THERE'S PO NO, CHOOSE THE REPORT W/O SIGNATURE **
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            C1Report2.Load(path & "OrderConfirmationForCableSurveywoSign.xml", "Order Confirmation For Cable Survey")
                                            C1Report2.DataSource.Recordset = ds.Tables(0)
                                            C1PrintPreviewControl1.Document = C1Report2.Document
                                        End If
                                    Else
                                        '** REPORT WITH SIGNATURE **
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            C1Report2.Load(path & "OrderConfirmationForCableSurvey.xml", "Order Confirmation For Cable Survey")
                                            C1Report2.DataSource.Recordset = ds.Tables(0)
                                            C1PrintPreviewControl1.Document = C1Report2.Document
                                        End If
                                    End If
                                ...
                                Case 4
                                    If Len(dsTmp.Tables(0).Rows(0)("Customer_PO")) > 0 Then
                                        '** IF THERE'S PO NO, CHOOSE THE REPORT W/O SIGNATURE **
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            C1Report2.Load(path & "OrderConfirmationForSwitchboardwoSign.xml", "Order Confirmation For Switchboard")
                                            C1Report2.DataSource.Recordset = ds.Tables(0)
                                            C1PrintPreviewControl1.Document = C1Report2.Document
                                        End If
                                    Else
                                        '** REPORT WITH SIGNATURE **
                                        If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                            'C1Report1.Load("../Reports/OrderConfirmationForSwitchboardSurvey.xml", "Order Confirmation For Switchboard")
                                            C1Report2.Load(path & "OrderConfirmationForSwitchboard.xml", "Order Confirmation For Switchboard")
                                            C1Report2.DataSource.Recordset = ds.Tables(0)
                                            C1PrintPreviewControl1.Document = C1Report2.Document
                                        End If
                                    End If
                        ...
                        Try
                            ...
                            Select Case (Special_ID)
                                ...
                                Case 4
                                    '** REPORT WITH SIGNATURE **
                                    If .GetOrderConfirmationRpt(ds, Quotation_ID, QuotationTitle, UserID) Then
                                        C1Report2.Load(path & "OrderConfirmationForSwitchboardSurvey.xml", "Order Confirmation For Switchboard")
                                        C1Report2.DataSource.Recordset = ds.Tables(0)
                                        C1PrintPreviewControl1.Document = C1Report2.Document
                                    End If
                            End Select
    ...
    Private Sub CloseBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CloseBtn.Click, Button1.Click
        Dim a As MainForm = Me.ParentForm
