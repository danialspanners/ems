...
Public Class NotificationOGBInstallRptForm
    Inherits System.Windows.Forms.Form

#Region " Windows Form Designer generated code "

    Public Sub New(ByVal pstrIO_ID As String, ByVal pCustomerName As String, Optional ByVal pEdit_Date As Date = #1/1/1900#, Optional ByVal pAttention_Name As String = "")
        MyBase.New()
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(NotificationOGBInstallRptForm))
        ...
        Me.Panel1.Size = New System.Drawing.Size(850, 55)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 440)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(850, 513)
        ...
        '
        'NotificationOGBInstallRptForm
        '
        Me.AutoScroll = True
        Me.ClientSize = New System.Drawing.Size(850, 568)
        Me.Controls.Add(Me.C1PrintPreviewControl1)
        Me.Controls.Add(Me.Panel1)
        Me.Name = "NotificationOGBInstallRptForm"
...
#End Region
    ...
    Private Sub NotificationOGBInstallRptForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With New BusinessRules.OGBBusRules.OGBBusLogic
            ...
            If .GetNotificationOGBInstallReport(ds, Edit_Date, strIO_ID, CustomerName, Attention_Name) Then
                Try
                    'Directory.SetCurrentDirectory("..\Reports\")
                    C1Report2.Load(path & "OGBInstallationReport.xml", "OGB Installation")
