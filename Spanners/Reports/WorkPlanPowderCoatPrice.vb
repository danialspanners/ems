...
Public Class WorkPlanPowderCoatPrice
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal pWO_ID As Integer)
        MyBase.New()
    ...
    Friend WithEvents CloseBtn As DevExpress.XtraEditors.Controls.XtraButton
     <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(WorkPlanPowderCoatPrice))
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 152)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(681, 225)
...
#End Region
    ...
    Private Sub WorkPlanPowderCoatPrice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With New BusinessRules.WorkPlanBusRules.WorkPlanBusLogic
            ...
            'If .GetWPLine_PowderCoatPricing(ds, WP_ID) Then
            Try
                .GetWPLine_PowderCoatPricing(ds, WP_ID)
                'Directory.SetCurrentDirectory("..\Reports\")
                C1Report1.Load(path & "WorkPlanPowderCoatPrice.xml", "Work Plan Powder Coating Price")
