...
Public Class SupplierListReportForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(Optional ByVal pSupplier_From As String = "" _
                   ...
                   , Optional ByVal pDate_To As String = "")

        MyBase.New()
        Supplier_From = pSupplier_From
        Supplier_To = pSupplier_To
        Supplier_Type = pSupplier_Type
        Supplier_Status = pSupplier_Status
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SupplierListReportForm))
        ...
        Me.Panel3.Size = New System.Drawing.Size(674, 66)
        ...
        Me.Panel4.Location = New System.Drawing.Point(536, 0)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 211)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(674, 284)
        ...
        Me.Name = "SupplierListReportForm"
...
#End Region
    ...
    Private Sub SupplierListReportForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With New BusinessRules.POBusRules.POLineBusLogic
            ...
            If .LoadSupplierPOReportList(ds, Supplier_From, Supplier_To, Supplier_Type, _
                                         Supplier_Status, Date_From, Date_To) Then
                ...
                Try
                    ...
                    C1Report1.Load(path & "SupplierListReport.xml", "Supplier List Report")
                    C1Report1.DataSource.Recordset = ds.Tables(0)
