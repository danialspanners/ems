...
Public Class DrawingNoReportForm
    Inherits System.Windows.Forms.Form

    Public strDrawing_ID As String
    Public DrawingNo_No As String
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal pstrDrawing_ID As String) ', ByVal pCustomer_Name As String, _
        ' ByVal pEdit_Date As String)
        MyBase.New()
        strDrawing_ID = pstrDrawing_ID
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(DrawingNoReportForm))
        ...
        Me.Panel3.Size = New System.Drawing.Size(681, 66)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 192)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(681, 265)
        ...
        'DrawingNoReportForm
        '
        Me.ClientSize = New System.Drawing.Size(681, 331)
        Me.Controls.Add(Me.C1PrintPreviewControl1)
        Me.Controls.Add(Me.Panel3)
        Me.Name = "DrawingNoReportForm"
...
#End Region
    ...
    Private Sub DrawingNoReportForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With New BusinessRules.DrawingBusRules.DrawingBusLogic
            ...
            If .GetDrawingNoReport(ds) Then
                Try
                    'Directory.SetCurrentDirectory("..\Reports\")
                    C1Report1.Load(path & "DrawingNoReport.xml", "Drawing No List")
