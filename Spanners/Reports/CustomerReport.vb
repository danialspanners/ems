...
Public Class CustomerReportForm
    ...
    Public strCustomer_ID As String
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal pstrCustomer_ID As String) ', ByVal pCustomer_Name As String, _
        ' ByVal pEdit_Date As String)
        MyBase.New()
        strCustomer_ID = pstrCustomer_ID
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(CustomerReportForm))
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(657, 267)
...
#End Region
    ...
    Private Sub CustomerReportForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With New BusinessRules.CustomerBusRules.CustomerBusLogic
            ...
            If .GetCustomerReport(ds) Then
                Try
                    'Directory.SetCurrentDirectory("..\Reports\")
                    C1Report1.Load(path & "CustomerReport.xml", "My Customers List")
