...
Public Class WorkOrderPOReportForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal pType As String, ByVal pWO_No As String)
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(WorkOrderPOReportForm))
        ...
        Me.Panel3.Size = New System.Drawing.Size(649, 66)
        ...
        Me.Panel4.Location = New System.Drawing.Point(511, 0)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 189)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(649, 262)
...
#End Region
    ...
    Private Sub WorkOrderPOReportForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        If Type = "1" Then ' Type equal "PO"
            ...
            With New BusinessRules.POBusRules.POLineBusLogic
                ...
                If .LoadWorkOrderPOReportList(ds, WO_No) Then
                    Try
                        'Directory.SetCurrentDirectory("..\Reports\")
                        C1Report1.Load(path & "WorkOrderPOReport.xml", "WO PO Report")
