...
Public Class OfficerReportForm
    Inherits System.Windows.Forms.Form

    Public strOfficer_ID As String
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal pstrOfficer_ID As String) ', ByVal pCustomer_Name As String, _
        ' ByVal pEdit_Date As String)
        MyBase.New()
        strOfficer_ID = pstrOfficer_ID
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OfficerReportForm))
        ...
        Me.Panel3.Size = New System.Drawing.Size(664, 66)
        ...
        Me.Panel4.Location = New System.Drawing.Point(526, 0)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(664, 256)
...
#End Region
    ...
    Private Sub OfficerReportForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With New BusinessRules.SystemBusRules.OfficerInChargeBusLogic
            ...
            If .GetOfficerReport(ds) Then
                Try
                    'Directory.SetCurrentDirectory("..\Reports\")
                    C1Report1.Load(path & "OfficerReport.xml", "My Officers List")
