...
Public Class WorkPlanReportForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(Optional ByVal pWP_ID As String = "0")
        MyBase.New()
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(WorkPlanReportForm))
        ...
        Me.Panel3.Size = New System.Drawing.Size(668, 66)
        ...
        Me.Panel4.Location = New System.Drawing.Point(530, 0)
        ...
        Me.C1PrintPreviewControl1.PreviewThumbnailView.Size = New System.Drawing.Size(165, 185)
        ...
        Me.C1PrintPreviewControl1.Size = New System.Drawing.Size(668, 258)
...
#End Region
    ...
    Private Sub WorkPlanReportForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With New BusinessRules.WorkPlanBusRules.WorkPlanBusLogic
            ...
            If .GetWPReport(ds, WP_ID) Then
                'C1Report1.Load("../Reports/WorkPlanReport.xml", "Work Plan")
                ...
                Try
                    ...
                    C1Report1.Load(path & "WorkPlanReport.xml", "Work Plan")
                    C1Report1.DataSource.Recordset = ds.Tables(0)
