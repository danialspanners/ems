Public Class OverStockAlertForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(OverStockAlertForm))
        ...
        'lblCount
        '
        Me.lblCount.Location = New System.Drawing.Point(96, 384)
        ...
        'lblTotalRecords
        '
        Me.lblTotalRecords.Location = New System.Drawing.Point(8, 384)
        Me.lblTotalRecords.Name = "lblTotalRecords"
        Me.lblTotalRecords.Size = New System.Drawing.Size(88, 16)
        Me.lblTotalRecords.TabIndex = 25
        ...
        Me.Name = "OverStockAlertForm"
        Me.Text = "Over Stock Alert"
...
#Region " Codes for Form Load"
    Private Sub OverStockAlertForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region " Component Grid Functions"
        ...
        With New BusinessRules.BusRules.InventoryBusLogic
            ...
            If Not dsStock Is Nothing Then
                ...
                For Each oRow In dsStock.Tables(0).Rows
                    i = i + 1
                    data.Rows.Add(New Object() {i, oRow("Product"), oRow("Description"), oRow("Category"), oRow("Max_Qty"), oRow("Total_Qty"), oRow("UOM")})
                Next
    ...
    Private Sub InitGrid()
        ...
        AddColumn(data, "Max Qty", System.Type.GetType("System.Int16"), True)
...
#Region " Codes for Buttons"
    ...
    Private Sub PrintBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintBtn.Click
        If Not GridView1.IsGroupRow(GridView1.GetSelectedRows(0)) Then
            ...
            controlToAdd = New MaxInventoryReportForm(Stock_ID)
            page = New Crownwood.Magic.Controls.TabPage("Print Over Stock Alert Report", controlToAdd, ImageList1, 0)
...
#End Region
    ...
    Private Sub OverStockAlertForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Dim a As MainForm = Me.ParentForm
