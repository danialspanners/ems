Public Class SelectFeedBackToPrintForm
...
'Sortby_ComboBox
'
Me.Sortby_ComboBox.Location = New System.Drawing.Point(103, 52)
...
Me.Sortby_ComboBox.Properties.Items.Add(New DevExpress.XtraEditors.Controls.ComboBoxItem("Serial No"))
Me.Sortby_ComboBox.Properties.Items.Add(New DevExpress.XtraEditors.Controls.ComboBoxItem("Install Date"))
...
Me.TabControl1.Size = New System.Drawing.Size(446, 219)
...
Me.TabPage2.Size = New System.Drawing.Size(438, 193)
...
Me.Advance_Panel.Location = New System.Drawing.Point(26, 232)
...
Me.GroupBox1.Size = New System.Drawing.Size(411, 103)
...
Me.Panel1.Size = New System.Drawing.Size(449, 44)
Me.Panel1.TabIndex = 23
'
'SelectFeedBackToPrintForm
'
...
Me.Name = "SelectFeedBackToPrintForm"
...
#End Region
    ...
    Private Sub SelectFeedBackToPrintForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadContractCmb()
        LoadSectionCmb()
    ...
    Private Sub SelectBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintButton.Click
        ...
        StartDate = Installdatefrom.DateTime.Day & "/" & Installdatefrom.DateTime.Month & "/" & Installdatefrom.DateTime.Year
        EndDate = installdateto.DateTime.Day & "/" & installdateto.DateTime.Month & "/" & installdateto.DateTime.Year

        Me.Close()
    End Sub
    Private Function CheckEntry()
        If Installdatefrom.DateTime.Ticks = 0 Then
            MessageBox.Show("Please enter the Start date", "Information not complete", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        ElseIf installdateto.DateTime.Ticks = 0 Then
            MessageBox.Show("Please enter the End date", "Information not complete", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        ElseIf Installdatefrom.DateTime.Ticks > installdateto.DateTime.Ticks Then
            MessageBox.Show("End Date must not be smaller than Start Date", "Information Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        ElseIf Me.ContractNoCmb.Text.Length = 0 Then
            MessageBox.Show("Please select a Contract to proceed", "Information not complete", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        End If
