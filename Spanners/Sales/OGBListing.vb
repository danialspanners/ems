...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OGBListingForm))
        ...
        Me.EditBtn.Size = New System.Drawing.Size(28, 17)
        ...
        Me.DelBtn.Size = New System.Drawing.Size(41, 17)
        ...
        Me.btnRefresh.Size = New System.Drawing.Size(48, 17)
...
#End Region
    ...
    Private Sub OGBListingForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '## Added by Andrew
        ...
        With New BusinessRules.OGBBusRules.OGBContractBusLogic
            If .GetOGBContract(ds) Then
                ...
                For Each oRow In ds.Tables(0).Rows
                    data.Rows.Add(New Object() {oRow("OGB_Contract_Id"), oRow("OGB_Contract_No")})
                Next
    ...
    Private Sub InitGrid()
		...
		data.BeginInit()
        AddColumn(data, "OGB_Contract_Id", System.Type.GetType("System.Int16"), True)
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    For Each oRow In ds.Tables(0).Rows
						...
						Else
							ParentIO = ""
						End If
                        data.Rows.Add(New Object() {oRow("OGB_IO_Id"), oRow("Contract_Id"), oRow("IO_No"), (oRow("Installation_Date")), ParentIO, oRow("Serial_No"), oRow("MRC_No")})
					Next
    ...
    Private Sub InitIOGrid()
        data = New DataTable("ColumnsTable")
        data.BeginInit()
        AddColumn(data, "OGB_IO_Id", System.Type.GetType("System.Int16"), True)
    ...
    Private Sub EditBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditBtn.Click
        If Not GridView1.IsGroupRow(GridView1.GetSelectedRows(0)) Then
            ...
            controlToAdd = New OGBForm(Contract_Id, "EDIT", OGB_IO_ID)
...
#End Region
    ...
    Private Sub ContractGrid_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ContractGrid.KeyUp, ContractGrid.DoubleClick
    ...
    Private Sub OGBListingForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Dim a As MainForm = Me.ParentForm
    ...
    Private Sub ContractGrid_KeyUp(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ContractGrid.DoubleClick
