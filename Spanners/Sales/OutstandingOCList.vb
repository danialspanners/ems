Public Class OutstandingOCForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.QuotationGrid.Size = New System.Drawing.Size(776, 368)
        ...
        Me.ApproveBtn.Location = New System.Drawing.Point(584, 384)
        ...
        Me.btnRefresh.Location = New System.Drawing.Point(504, 384)
        ...
        Me.Name = "OutstandingOCForm"
        Me.Text = "Outstanding Order Confirmation Listing"
...
#End Region
    ...
    Private Sub OutstandingOCListForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadOCList()
    End Sub

    Private Sub LoadOCList()
        Dim ds As DataSet
        Dim dsParent As DataSet
        Dim dsProject As DataSet
        With New BusinessRules.SaleBusRules.SaleBusLogic
            If .GetOrderConfirmHeader(ds, , "20") Then
                InitGrid()
                Dim oRow As DataRow
                Dim i As Integer = 0
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For Each oRow In ds.Tables(0).Rows
                        ...
                        With New BusinessRules.SystemBusRules.ProjectBusLogic
                            ...
                            End If
                        End With
                        'MessageBox.Show(oRow("Quotation_ID") & i & oRow("Confirm_Quotation_No") & ChangeDateFormat(oRow("QuotationDate")) & oRow("Status") & Status & ProjectTitle & oRow("CustomerName") & oRow("Initial"))
                        data.Rows.Add(New Object() {oRow("Quotation_ID"), i, oRow("Confirm_Quotation_No"), ChangeDateFormat(oRow("QuotationDate")), oRow("Status"), Status, ProjectTitle, oRow("CustomerName"), oRow("Initial")})
                    Next
    ...
    Private Sub InitGrid()
        ...
        AddColumn(data, "Date", System.Type.GetType("System.DateTime"), True)
...
#End Region
    ...
    Private Sub OutstandingOCForm_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub OutstandingOCForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
