...
Public Class ServiceOrderConfirmationForm
    Inherits System.Windows.Forms.Form

    'Service OC - Providing services.
    'e.g. - Labour.
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TabControl1.SelectedTab = Me.OthersTab
        ...
        Me.StatusLbl.Location = New System.Drawing.Point(488, 62)
        ...
        Me.Name = "ServiceOrderConfirmationForm"
        Me.Text = "Service Order Confirmation"
...
#Region " Generate Trading Order Confirmation No "
    Private Function GetOrderConfirmationNo(ByVal pCustInitial As String) As String
        ...
        With New BusinessRules.CommonBusRules.CommonLogic
            .UserID = UserID
            DocumentNo = .GetDocumentNextNumber("SOC")
        End With
...
#Region " Save, Del, Retrieve from form function for Quotation Line."
    Private Sub RetrieveFromLineForm()
        ...
        Cost = CompTotal '+ Enclosure       '* Don't have Enclosure
