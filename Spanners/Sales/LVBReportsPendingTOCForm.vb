Public Class LVBReportsPendingTOCForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.IOGrid.Size = New System.Drawing.Size(876, 446)
        ...
        Me.Panel1.Size = New System.Drawing.Size(876, 57)
        ...
        Me.Name = "LVBReportsPendingTOCForm"
...
#End Region
            ...
            If .GetIOWContractIdRptPendingTOC(ds) Then
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    For Each oRow In ds.Tables(0).Rows
                        ...
                        data.Rows.Add(New Object() {oRow("IO_Id"), oRow("Contract_Id"), Index_No, OfficerName, SectionCode, oRow("IO_No"), oRow("LVB_Location"), ChangeDateFormat(oRow("Commence_Date")), ChangeDateFormat(oRow("Completion_Date")), ChangeDateFormat(oRow("Installation_Date"))})
                    Next
                End If
    ...
    Private Sub PrintBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Not GridView2.IsGroupRow(GridView2.GetSelectedRows(0)) Then
            ...
            'controlToAdd = New LVBReportsPendingTOCRptForm(IO_ID, Sortby)
            page = New Crownwood.Magic.Controls.TabPage("Print LVB Pending TOC.", controlToAdd, ImageList1, 0)
    ...
    Private Sub LVBReportsPendingTOCForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Dim a As MainForm = Me.ParentForm
