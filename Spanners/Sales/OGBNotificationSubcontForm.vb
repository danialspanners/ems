Public Class OGBNotificationSubcontForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OGBNotificationSubcontForm))
        ...
        Me.IOGrid.Size = New System.Drawing.Size(760, 446)
        ...
        Me.Panel1.Size = New System.Drawing.Size(760, 57)
        ...
        Me.Name = "OGBNotificationSubcontForm"
...
#End Region
    ...
    Private Sub OGBNotificationSubcontForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadIOList()
    End Sub
        ...
        If GridView2.SelectedRowsCount <> 0 Then
            If Not GridView2.IsGroupRow(GridView2.GetSelectedRows(0)) Then
                ...
                If Not (arr Is Nothing) Then
                    ...
                    controlToAdd = New NotificationOGBInstallRptForm(StrIO_ID, "")
    ...
    Private Sub OGBNotificationSubcontForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Dim a As MainForm = Me.ParentForm
